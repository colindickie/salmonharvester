...
#Region "Events"
        ...
        If m_PLCAddressClick <> "" Then
            Try
                Select Case OutputType
                    Case OutputTypes.MomentarySet : _CommComponent.Write(m_PLCAddressClick, 1)
                    Case OutputTypes.MomentaryReset : _CommComponent.Write(m_PLCAddressClick, 0)
                    Case OutputTypes.SetTrue : _CommComponent.Write(m_PLCAddressClick, 1)
                    Case OutputTypes.SetFalse : _CommComponent.Write(m_PLCAddressClick, 0)
    ...
    Private Sub MomentaryButton_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseUp
        If m_PLCAddressClick <> "" Then
            Try
                Select Case OutputType
                    Case OutputTypes.MomentarySet : _CommComponent.Write(m_PLCAddressClick, 0)
                    Case OutputTypes.MomentaryReset : _CommComponent.Write(m_PLCAddressClick, 1)
                End Select
    ...
    Private Sub PolledDataReturnedSelect1(ByVal sender As Object, ByVal e As MfgControl.AdvancedHMI.Drivers.Common.PlcComEventArgs)
        Try
            ValueSelect1 = e.Values(0)
        Catch
    ...
    Private Sub PolledDataReturnedSelect2(ByVal sender As Object, ByVal e As MfgControl.AdvancedHMI.Drivers.Common.PlcComEventArgs)
        Try
            ValueSelect2 = e.Values(0)
        Catch
    ...
    '************************************************************
    Private Sub PolledDataReturnedText2(ByVal sender As Object, ByVal e As MfgControl.AdvancedHMI.Drivers.Common.PlcComEventArgs)
        Try
            Text2 = e.Values(0)
            'LegendText = e.Values(0)
        Catch
