...
Public Class EthernetIPforPLCSLCMicroCom
    ...
    Private Shared DLL(11) As MfgControl.AdvancedHMI.Drivers.CIP
...
#Region "Constructor"
    ...
    Friend Overrides Sub CreateDLLInstance()
        If DLL(0) IsNot Nothing Then
            ...
            Dim i As Integer
            While DLL(i) IsNot Nothing AndAlso DLL(i).EIPEncap.IPAddress <> m_IPAddress AndAlso i < 13
                i += 1
            End While
            MyDLLInstance = i
        End If
...
#Region "Helper"
    ...
    Friend Overrides Function WaitForResponse(ByVal rTNS As Integer) As Integer
        ...
        While Not Responded(rTNS And 255) And Loops < MaxTicks
